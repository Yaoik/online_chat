...
from chat.models import Channel, ChannelMembership, Message, Invitation
...
class TestPermissions:
    def test_only_author_or_admin_can_edit_message(self, authenticated_client, channel_membership, message):
        ...
        url = reverse('channel-messages-detail', kwargs={'channel_uuid': channel_membership.channel.uuid, 'message_uuid': message.uuid})
